...
namespace Pad
{
	...
	static constexpr float DEFAULT_STICK_SCALE = 1.0f;
	static constexpr float DEFAULT_BUTTON_ANTI_DEADZONE = 0.0f;
	static constexpr float DEFAULT_BUTTON_SCALE = 1.0f;
